...
public class TurnWithPIDCommand extends Command {
    ...
    protected void initialize() {
    	this.pid = org.usfirst.frc.team649.robot.Robot.commandBase.drivetrainSubsystem.getGyroPIDControler();
		...
		Robot.commandBase.drivetrainSubsystem.resetGyro();
		pid.enable();
    }
    ...
    protected void end() {
    	pid.disable();
		org.usfirst.frc.team649.robot.Robot.commandBase.drivetrainSubsystem.driveFwdRot(0, 0);
    }
